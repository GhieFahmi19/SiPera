				...
				<div class="col-md-3">
					<div class="box box-primary">
						<div class="box-body box-profile">
							<?php if ($pamong['foto']) : ?>
								<img class="profile-user-img img-responsive img-circle" src="" alt="Foto">
							<?php else : ?>
					...
					<div class="box box-primary">
						<div class="box-body">
							...
							<div class="form-group">
								...
								<div class="col-sm-7">
									<input class="form-control input-sm pengurus-desa" type="text" placeholder="Tanggal Lahir" value="" disabled="disabled"></input>
									<div class="input-group input-group-sm date pengurus-luar-desa" style="display: none;">
										<div class="input-group-addon">
											<i class="fa fa-calendar"></i>
										</div>
										<input class="form-control input-sm pull-right tgl_1" name="pamong_tanggallahir" type="text" value="">
									</div>
								</div>
							</div>
							<div class="form-group">
							...
							<div class='form-group'>
								...
								<div class="col-sm-7">
									<div class="input-group input-group-sm date">
										...
										<input class="form-control input-sm pull-right tgl_1" name="pamong_tglsk" type="text" value="">
									</div>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-7">
									<input name="pamong_nohenti" class="form-control input-sm" type="text" placeholder="Nomor SK Pemberhentian" value=""></input>
								</div>
							</div>
							<div class='form-group'>
								...
								<div class="col-sm-7">
									<div class="input-group input-group-sm date">
										...
										<input class="form-control input-sm pull-right tgl_1" name="pamong_tglhenti" type="text" value="">
									</div>
								</div>
							</div>
							<div class="form-group">
