                                            ...
                                            <tbody>
                                                <tr role="row" class="odd">
                                                    <td class="sorting_1 dtr-control">
                                                        <div class="btn-group btn-group-sm"><a href="../files/sm/" class="btn btn-sm btn-dark" target="_blank"><i class="fas fa-folder-open"></i> View</a> <button type="button" class="btn btn-dark dropdown-toggle dropdown-icon" data-toggle="dropdown" aria-expanded="false"> <span class="sr-only">Toggle Dropdown</span> </button>
                                                ...
                                                <tr role="row" class="odd">
                                                    <td class="sorting_1 dtr-control">
                                                        <div class="btn-group btn-group-sm "><a role="button" class="btn btn-sm btn-dark"><i class="fas fa-edit"></i> Actions</a> <button type="button" class="btn btn-dark dropdown-toggle dropdown-icon" data-toggle="dropdown"> <span class="sr-only">Toggle Dropdown</span> </button>
                                                            <div class="dropdown-menu" role="menu"><button onclick="edit_user_access()" class="dropdown-item"><i class="fas fa-edit"></i> Edit</button><button onclick="del_user()" class="dropdown-item text-danger"><i class="fas fa-times"></i> Delete</button> </div>
                                                        </div>
                                                    </td>
