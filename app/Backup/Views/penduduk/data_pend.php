      ...
      <div class="card-body">
        <div id="dtbl-index_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
          ...
          <div class="row">
            <div class="col-sm-12">
              <table class="table table-striped table-bordered dataTable no-footer dtr-inline" id="dtbl-index" role="grid" aria-describedby="dtbl-index_info" style="width: 100%;" width="100%" cellspacing="0">
                <tr role="row">
                  ...
                  <th class="sorting" tabindex="0" aria-controls="dtbl-index" rowspan="1" colspan="1" style="width: 86px;" aria-label="Penyimpanan: activate to sort column ascending">Penyimpanan</th>
                </tr>
                </thead>
                <tbody>
                  <tr role="row" class="odd">
                    ...
                    <td>
                      <div class="btn-group btn-group-sm"><a href="../surat-masuk/view/" class="btn btn-sm btn-dark"><i class="fas fa-folder-open"></i> View</a>
                        ...
                        <div class="dropdown-menu" role="menu" style="">
                          <a href="../surat-masuk/edit/" class="dropdown-item"><i class="fas fa-edit"></i> Edit</a>
                        </div>
                      </div>
            </div>
            </tr>
            <tr role="row" class="even">
              ...
              <td>
                <div class="btn-group btn-group-sm ">
                  <a href="../surat-masuk/view/" class="btn btn-sm btn-dark"><i class="fas fa-folder-open"></i> View</a>
            ...
            <tr role="row" class="odd">
              <td class="sorting_1 dtr-control">14</td>
              <td>
                <div class="btn-group btn-group-sm ">
                  <a href="../surat-masuk/view/" class="btn btn-sm btn-dark"><i class="fas fa-folder-open"></i> View</a>
                  <button type="button" class="btn btn-dark dropdown-toggle dropdown-icon" data-toggle="dropdown"><span class="sr-only">Toggle Dropdown</span></button>
            ...
            <tr role="row" class="even">
              <td class="sorting_1 dtr-control">13</td>
              <td>
                <div class="btn-group btn-group-sm ">
              ...
              <div id="dtbl-index_processing" class="dataTables_processing card" style="display: none;">Processing...</div>
          </div>
        </div>
        <div class="row">
          <div class="col-sm-12 col-md-5">
            <div class="dataTables_info" id="dtbl-index_info" role="status" aria-live="polite">Showing 1 to 8 of 8 entries</div>
          </div>
          <div class="col-sm-12 col-md-7">
            <div class="dataTables_paginate paging_simple_numbers" id="dtbl-index_paginate">
              <ul class="pagination">
                <li class="paginate_button page-item previous disabled" id="dtbl-index_previous">
                  <a href="#" aria-controls="dtbl-index" data-dt-idx="0" tabindex="0" class="page-link">Previous</a>
                </li>
