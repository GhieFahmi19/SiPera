                      ...
                      <div class="row" data-select2-id="5">
                        <div class="col-sm-6" data-select2-id="4">
                          <select class="form-control select2 select2-hidden-accessible" id="nik" name="nik" onchange="formAction('main')" style="width: 100%;" data-select2-id="nik" tabindex="-1" aria-hidden="true">
                            ...
                            <option value="surat_jalan" data-select2-id="19">KETERANGAN BEPERGIAN / JALAN</option>
                            ...
                            <option value="surat_permohonan_duplikat_kelahiran" data-select2-id="29">PERMOHONAN DUPLIKAT KELAHIRAN</option>
                            ...
                            <option value="surat_ket_nikah" data-select2-id="32">KETERANGAN UNTUK NIKAH (N-1 S/D N-7)</option>
                                ...
                                <table class="table table-bordered dataTable table-striped table-hover">
                                  ...
                                  <tbody>
                                    <tr>
                                      <td>1</td>
                                      <td class="nostretch">
                                        <a href="../surat/form/surat_ket_pengantar" class="btn btn-icon icon-left btn-primary"><i class="far fa-file-alt"></i>Buat Surat</a>
                                    ...
                                    <tr>
                                      <td>2</td>
                                      <td class="nostretch">
                                        <a href="../surat/surat_ket_penduduk" class="btn btn-icon icon-left btn-primary"><i class="far fa-file-alt"></i>Buat Surat</a>
                                    ...
                                    <tr>
                                      <td>4</td>
                                      <td class="nostretch">
                                        <a href="../surat/form/surat_ket_pindah_penduduk" class="btn btn-icon icon-left btn-primary"><i class="far fa-file-alt"></i>Buat Surat</a>
                                    ...
                                    <tr>
                                      <td>5</td>
                                      <td class="nostretch">
                                        <a href="../surat/form/surat_ket_jual_beli" class="btn btn-icon icon-left btn-primary"><i class="far fa-file-alt"></i>Buat Surat</a>
                                    ...
                                    <tr>
                                      <td>6</td>
                                      <td class="nostretch">
                                        <a href="../surat/form/surat_ket_catatan_kriminal" class="btn btn-icon icon-left btn-primary"><i class="far fa-file-alt"></i>Buat Surat</a>
                                    ...
                                    <tr>
                                      <td>7</td>
                                      <td class="nostretch">
                                        <a href="../surat/form/surat_ket_ktp_dalam_proses" class="btn btn-icon icon-left btn-primary"><i class="far fa-file-alt"></i>Buat Surat</a>
                                    ...
                                    <tr>
                                      <td>8</td>
                                      <td class="nostretch">
                                        <a href="../surat/form/surat_ket_beda_nama" class="btn btn-icon icon-left btn-primary"><i class="far fa-file-alt"></i>Buat Surat</a>
                                    ...
                                    <tr>
                                      <td>9</td>
                                      <td class="nostretch">
                                        <a href="../surat/form/surat_jalan" class="btn btn-icon icon-left btn-primary"><i class="far fa-file-alt"></i>Buat Surat</a>
                                        <a href="../surat/favorit/11/0" class="btn bg-purple btn-flat btn-sm" title="Tambahkan ke Daftar Favorit"><i class="fa fa-star-o"></i></a>
                                      </td>
                                      <td>Keterangan Bepergian / Jalan</td>
                                      <td>S-10</td>
                                      <td></td>
                                    </tr>
                                    <tr>
                                      <td>10</td>
                                      <td class="nostretch">
                                        <a href="../surat/form/surat_ket_kurang_mampu" class="btn btn-icon icon-left btn-primary"><i class="far fa-file-alt"></i>Buat Surat</a>
                                    ...
                                    <tr>
                                      <td>11</td>
                                      <td class="nostretch">
                                        <a href="../surat/form/surat_izin_keramaian" class="btn btn-icon icon-left btn-primary"><i class="far fa-file-alt"></i>Buat Surat</a>
                                    ...
                                    <tr>
                                      <td>12</td>
                                      <td class="nostretch">
                                        <a href="../surat/form/surat_ket_kehilangan" class="btn btn-icon icon-left btn-primary"><i class="far fa-file-alt"></i>Buat Surat</a>
                                    ...
                                    <tr>
                                      <td>13</td>
                                      <td class="nostretch">
                                        <a href="../surat/form/surat_ket_usaha" class="btn btn-icon icon-left btn-primary"><i class="far fa-file-alt"></i>Buat Surat</a>
                                    ...
                                    <tr>
                                      <td>14</td>
                                      <td class="nostretch">
                                        <a href="../surat/form/surat_ket_jamkesos" class="btn btn-icon icon-left btn-primary"><i class="far fa-file-alt"></i>Buat Surat</a>
                                    ...
                                    <tr>
                                      <td>15</td>
                                      <td class="nostretch">
                                        <a href="../surat/form/surat_ket_domisili_usaha" class="btn btn-icon icon-left btn-primary"><i class="far fa-file-alt"></i>Buat Surat</a>
                                    ...
                                    <tr>
                                      <td>16</td>
                                      <td class="nostretch">
                                        <a href="../surat/form/surat_ket_kelahiran" class="btn btn-icon icon-left btn-primary"><i class="far fa-file-alt"></i>Buat Surat</a>
                                    ...
                                    <tr>
                                      <td>17</td>
                                      <td class="nostretch">
                                        <a href="../surat/form/surat_permohonan_akta" class="btn btn-icon icon-left btn-primary"><i class="far fa-file-alt"></i>Buat Surat</a>
                                    ...
                                    <tr>
                                      <td>18</td>
                                      <td class="nostretch">
                                        <a href="../surat/form/surat_pernyataan_akta" class="btn btn-icon icon-left btn-primary"><i class="far fa-file-alt"></i>Buat Surat</a>
                                    ...
                                    <tr>
                                      <td>19</td>
                                      <td class="nostretch">
                                        <a href="../surat/form/surat_permohonan_duplikat_kelahiran" class="btn btn-icon icon-left btn-primary"><i class="far fa-file-alt"></i>Buat Surat</a>
                                        <a href="../surat/favorit/22/0" class="btn bg-purple btn-flat btn-sm" title="Tambahkan ke Daftar Favorit"><i class="fa fa-star-o"></i></a>
                                      </td>
                                      <td>Permohonan Duplikat Kelahiran</td>
                                      <td>S-20</td>
                                      <td></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                      <td>21</td>
                                      <td class="nostretch">
                                        <a href="../surat/form/surat_ket_lahir_mati" class="btn btn-icon icon-left btn-primary"><i class="far fa-file-alt"></i>Buat Surat</a>
                                    ...
                                    <tr>
                                      <td>22</td>
                                      <td class="nostretch">
                                        <a href="../surat/form/surat_ket_nikah" class="btn btn-icon icon-left btn-primary"><i class="far fa-file-alt"></i>Buat Surat</a>
                                    ...
                                    <tr>
                                      <td>23</td>
                                      <td class="nostretch">
                                        <a href="../surat/form/surat_ket_pergi_kawin" class="btn btn-icon icon-left btn-primary"><i class="far fa-file-alt"></i>Buat Surat</a>
                                    ...
                                    <tr>
                                      <td>24</td>
                                      <td class="nostretch">
                                        <a href="../surat/form/surat_ket_wali_hakim" class="btn btn-icon icon-left btn-primary"><i class="far fa-file-alt"></i>Buat Surat</a>
                                    ...
                                    <tr>
                                      <td>25</td>
                                      <td class="nostretch">
                                        <a href="../surat/form/surat_permohonan_duplikat_surat_nikah" class="btn btn-icon icon-left btn-primary"><i class="far fa-file-alt"></i>Buat Surat</a>
                                    ...
                                    <tr>
                                      <td>26</td>
                                      <td class="nostretch">
                                        <a href="../surat/form/surat_permohonan_cerai" class="btn btn-icon icon-left btn-primary"><i class="far fa-file-alt"></i>Buat Surat</a>
