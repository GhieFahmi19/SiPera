                                      ...
                                      <div class="row">
                                          <div class="col-sm-9">
                                              <form id="mainform" name="mainform" method="post">
                                                  <select class="form-control input-sm" name="sasaran" onchange="formAction('mainform', 'program_bantuan/filter/sasaran')">
                                                  ...
                                                  <table class="table table-bordered table-striped dataTable table-hover" id="table-program">
                                                      ...
                                                      <tbody>
                                                          <tr>
                                                              ...
                                                              <td nowrap>
                                                                  <a href="/program_bantuan/detail/1" class="btn bg-purple btn-flat btn-sm" title="Rincian"><i class="fa fa-list"></i></a>
                                                                  <a href="/program_bantuan/edit/1" class="btn bg-orange btn-flat btn-sm" title="Ubah"><i class="fa fa-edit"></i></a>
                                                                  <a href="/program_bantuan/expor/1" class="btn bg-navy btn-flat btn-sm" title="Expor"><i class="fa fa-download"></i></a>
                                                              ...
                                                              <td nowrap><a href="/program_bantuan/detail/1">BPNT</a></td>
                                                              <td>Pusat</td>
                                                              <td>2</td>
                                                          ...
                                                          <tr>
                                                              ...
                                                              <td nowrap>
                                                                  <a href="/program_bantuan/detail/2" class="btn bg-purple btn-flat btn-sm" title="Rincian"><i class="fa fa-list"></i></a>
                                                                  <a href="/program_bantuan/edit/2" class="btn bg-orange btn-flat btn-sm" title="Ubah"><i class="fa fa-edit"></i></a>
                                                                  <a href="/program_bantuan/expor/2" class="btn bg-navy btn-flat btn-sm" title="Expor"><i class="fa fa-download"></i></a>
                                                                  <a href="#" class="btn bg-maroon btn-flat btn-sm disabled" title="Hapus" data-toggle="modal" data-target="#confirm-delete"><i class="fa fa-trash-o"></i></a>
                                                              </td>
                                                              <td nowrap><a href="/program_bantuan/detail/2">BLSM</a></td>
                                                              <td>Pusat</td>
                                                              <td>2</td>
                                                          ...
                                                          <tr>
                                                              ...
                                                              <td nowrap><a href="/program_bantuan/detail/5">JAMKESMAS</a></td>
                                                              <td>Pusat</td>
                                                              <td>2</td>
  ...
  <div class="modal fade" id="impor">
      <div class="modal-dialog">
          <div class="modal-content">
              ...
              <form id="mainform" action="/program_bantuan/impor" method="POST" enctype="multipart/form-data">
                  <div class="modal-body">
                      <div class="form-group">
                          ...
                          <br />
                          <a href="/assets/import/format_impor_program_bantuan.xlsx" class="btn btn-social btn-flat bg-purple btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block text-center"><i class="fa fa-file-excel-o"></i> Contoh Format Impor Program Bantuan</a>
                      </div>
                  </div>
                  <div class="modal-footer">
